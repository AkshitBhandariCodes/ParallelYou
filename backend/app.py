...
def generate_character():
    ...
    character_name = f"{name}-{random.randint(1000, 9999)}"
    ...
    character = {
        ...
        'image': f"/placeholder.svg?height=400&width=400"  # Use consistent key name
    }
...
def get_history():
    ...
    for item in history:
        ...
        formatted_history.append({
            ...
            'image': item.get('image', f"/placeholder.svg?height=100&width=100")
        })
